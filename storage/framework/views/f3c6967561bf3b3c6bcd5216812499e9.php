                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><?php echo e($payment->transaction_id ?? 'N/A'); ?></p>
                        </div>
                        <div class="col-md-6">
                            <strong>Fecha:</strong>
                            <p class="mb-0"><?php echo e($payment->created_at->format('d/m/Y H:i:s')); ?></p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-0 text-success fs-4">
                                <?php if($payment->currency === 'USD'): ?>
                                    $<?php echo e(number_format($payment->amount, 2)); ?> USD
                                <?php elseif($payment->currency === 'CRC'): ?>
                                    ₡<?php echo e(number_format($payment->amount, 2)); ?> CRC
                                <?php elseif($payment->currency === 'EUR'): ?>
                                    €<?php echo e(number_format($payment->amount, 2)); ?> EUR
                                <?php elseif($payment->currency === 'MXN'): ?>
                                    $<?php echo e(number_format($payment->amount, 2)); ?> MXN
                                <?php else: ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <p class="mb-0">
                                    ...
                                    **** **** **** <?php echo e($payment->card_last_four); ?>

                                </p>
                            </div>
                            <div class="col-md-6">
                                <strong>Tipo:</strong>
                                <p class="mb-0"><?php echo e(ucfirst($payment->card_type ?? 'N/A')); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($payment->authorization_code): ?>
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <p class="mb-0"><?php echo e($payment->authorization_code); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>

                    <?php if($payment->flow_type): ?>
                        <div class="row mb-3">
                            <div class="col-12">
                                <strong>Tipo de Autenticación:</strong>
                                <p class="mb-0">
                                    <?php if($payment->flow_type === 'frictionless'): ?>
                                        <i class="fas fa-shield-check text-success me-2"></i>
                                        3D Secure - Sin Fricción
                                    <?php elseif($payment->flow_type === 'challenge'): ?>
                                        <i class="fas fa-shield-alt text-primary me-2"></i>
                                        3D Secure - Challenge
                                    <?php else: ?>
                                        <?php echo e(ucfirst($payment->flow_type)); ?>
                    ...
                    <?php if($payment->liability_shift): ?>
            ...
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <a href="<?php echo e(route('payment.history')); ?>" class="btn btn-outline-secondary w-100">
...
<?php /**PATH C:\xampp\htdocs\pasarelacybersource\resources\views/modules/payment/success-content.blade.php ENDPATH**/ ?>