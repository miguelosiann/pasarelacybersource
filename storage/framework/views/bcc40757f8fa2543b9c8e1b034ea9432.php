...
<body>
    <div class="container">
        ...
        <div class="cards-container">
            ...
            <!-- Card de Historial -->
            <a href="<?php echo e(route('payment.history')); ?>" class="card">
                <div class="card-icon">📊</div>
        ...
        <div class="info-section">
            ...
            <p><strong>Historial de Pagos:</strong> <a href="<?php echo e(route('payment.history')); ?>">Ver todas las transacciones →</a></p>
...
<?php /**PATH C:\xampp\htdocs\pasarelacybersource\resources\views/welcome.blade.php ENDPATH**/ ?>