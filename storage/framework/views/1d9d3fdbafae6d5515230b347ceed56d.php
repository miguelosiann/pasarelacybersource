            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="error-message" class="alert alert-danger mt-4 d-none" role="alert">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-danger mt-2" onclick="window.location.href='<?php echo e(route('payment.checkout')); ?>'">
                            Volver a intentar
                        </button>
                    </div>
                </div>
...
<form id="challenge-form" 
      action="<?php echo e($challengeData['step_up_url'] ?? ''); ?>" 
      method="POST" 
      target="challengeFrame"
      class="payment-hidden">
    <?php if(isset($challengeData['access_token'])): ?>
        <input type="hidden" name="JWT" value="<?php echo e($challengeData['access_token']); ?>">
    <?php endif; ?>
    <?php if(isset($challengeData['reference_id'])): ?>
        <input type="hidden" name="MD" value="<?php echo e($challengeData['reference_id']); ?>">
    <?php endif; ?>
</form>
...
// Configuration
const config = {
    challengeReturnUrl: "<?php echo e(route('payment.challenge.callback')); ?>",
    successUrl: "<?php echo e(route('payment.success', ['payment' => 'PAYMENT_ID'])); ?>",
    failedUrl: "<?php echo e(route('payment.failed')); ?>",
    authorizeUrl: "<?php echo e(route('payment.challenge.authorize')); ?>",
...
<?php /**PATH C:\xampp\htdocs\pasarelacybersource\resources\views/modules/payment/challenge-content.blade.php ENDPATH**/ ?>